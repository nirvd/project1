                                ...
                                <div class="col-md-6">
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        echo "<img src='img/".$row['profile']."'
                                         style='height: 250px;' class='col-md-12 my-3'>";
                                        ?>
                                    ...
                                    <div class="my-3">
                                        <table class="table table-bordered">
                                            <tr>
                                            <th colspan="2" class="text-center">Details
                                ...
                                <div class="col-md-6">
                                    ...
                                    <form method="post">
                                        <div class="form-group">
                                            ...
                                            autocomplete="off" placeholder="Eneter Old password">
                                        </div>
                                        <div class="form-group">
                                            <label>New password</label>
                                            <input type="password" name="new_pass" class="form-control"
                                            autocomplete="off" placeholder="Eneter New password">
                                        </div>
                                        <div class="form-group">
